    ...
    internal class QuadroDevice : IAquacomputerDevice
    {
        ...
        public void Update()
        {
            ...
            if (deviceData != null)
            {
                ...
                EndianAttribute.GetStructAtOffset<AquacomputerStructs.Devices.Quadro.device_status>(deviceData, ref offset);
                sensor_data = EndianAttribute.GetStructAtOffset<AquacomputerStructs.Devices.Quadro.sensor_data>(deviceData, ref offset);
            }
        ...
        private bool Settings_UpdateSettings(bool force = false)
        {
            ...
            {
                _logger.Log($"QuadroDevice: Failed to read settings from device: {ex}");
                return false;
            }
        }
        ...
        private void Settings_SetControllerPower(int index, float? val)
        {
            ...
            {
                _logger.Log($"QuadroDevice.Settings_SetControllerPower() error: {ex}");
            }
